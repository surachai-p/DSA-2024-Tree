...
ตอบ Binary Search Tree มีประสิทธิภาพในการค้นหาข้อมูลมากกว่า Linear Search เพราะวิธีการค้นหาของ BST ใช้หลักการ แบ่งครึ่งและตัดทิ้ง  
เช่นถ้าเรามีข้อมูล 100 ตัว ถ้าใช้ Linear Search เราต้องไล่ดูทีละตัวไปเรื่อยๆ ในกรณีที่แย่ที่สุดอาจต้องดูถึง 100 ครั้ง แต่ถ้าใช้ BST ทุกครั้งที่เราเปรียบเทียบกับโหนดหนึ่ง เราจะสามารถตัดข้อมูลออกไปได้ครึ่งหนึ่ง เพราะถ้าค่าที่เราหามากกว่า เราก็ไปทางขวา ถ้าน้อยกว่าก็ไปทางซ้าย ทำให้จำนวนการเปรียบเทียบลดลงเหลือแค่ประมาณ 7 ครั้งเท่านั้นสำหรับข้อมูล 100 ตัว

2. ในกรณีใดบ้างที่ BST จะมีประสิทธิภาพในการค้นหาเทียบเท่ากับ Linear Search?
ตอบ ในกรณีที่ข้อมูลเข้ามาแบบเรียงลำดับแล้วครับ เช่น ถ้าเราใส่ตัวเลข 1, 2, 3, 4, 5 เข้าไปตามลำดับ ต้นไม้ของเราจะเอียงไปด้านขวาทั้งหมด กลายเป็นเหมือนเส้นตรง ทำให้การค้นหาต้องไล่ไปทีละโหนดเหมือน Linear Search 

3. จงอธิบายความแตกต่างระหว่าง Binary Tree และ Binary Search Tree
ตอบ ความแตกต่างระหว่าง Binary Tree กับ Binary Search Tree อยู่ที่กฎการจัดเรียงข้อมูลครับ Binary Tree แต่ละโหนดจะมีลูกได้ไม่เกิน 2 ตัว แต่ไม่มีกฎว่าข้อมูลต้องจัดเรียงอย่างไร ใส่ตัวไหนไว้ตรงไหนก็ได้ แต่ BST มีกฎเพิ่มขึ้นมาว่า ข้อมูลทางซ้ายทั้งหมดต้องน้อยกว่าโหนดพ่อ และข้อมูลทางขวาทั้งหมดต้องมากกว่าโหนดพ่อ กฎนี้ทำให้เราสามารถค้นหาข้อมูลได้เร็วขึ้น เพราะรู้ว่าควรไปทางไหนต่อ

4. การ Traversal แบบใดที่จะแสดงผลข้อมูลเรียงลำดับจากน้อยไปมากเมื่อใช้กับ BST?
ตอบ การ Traversal ที่จะแสดงผลข้อมูลเรียงลำดับจากน้อยไปมากใน BST คือการ Inorder Traversal  วิธีนี้จะเดินทางซ้ายสุดก่อน แล้วค่อยเก็บค่าโหนดปัจจุบัน จากนั้นไปทางขวา ซึ่งเมื่อทำกับ BST จะได้ข้อมูลเรียงจากน้อยไปมากโดยอัตโนมัติ เพราะด้วยกฎการจัดเรียงของ BST ทำให้ข้อมูลทางซ้ายต้องน้อยกว่าโหนดพ่อเสมอ และข้อมูลทางขวาต้องมากกว่าโหนดพ่อเสมอ 
