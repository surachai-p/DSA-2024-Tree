...
ตอบ = BST มีประสิทธิภาพในการค้นหามากกว่า Linear Search เพราะใช้โครงสร้างแบบแบ่งครึ่ง
2. ในกรณีใดบ้างที่ BST จะมีประสิทธิภาพในการค้นหาเทียบเท่ากับ Linear Search?
ตอบ = BST มีประสิทธิภาพเทียบเท่า Linear Search เมื่อ BST ไม่สมดุล 
3. จงอธิบายความแตกต่างระหว่าง Binary Tree และ Binary Search Tree
ตอบ = Binary Tree เป็นโครงสร้างต้นไม้ที่แต่ละโหนดมีลูกได้ไม่เกิน 2 ตัว ส่วน Binary Search Tree (BST) ค่าทางซ้ายต้องน้อยกว่าโหนดหลัก และค่าทางขวาต้องมากกว่าโหนดหลัก
4. การ Traversal แบบใดที่จะแสดงผลข้อมูลเรียงลำดับจากน้อยไปมากเมื่อใช้กับ BST?
จอบ = In-order Traversal ใช้กับ BST แล้วจะแสดงผลข้อมูลเรียงลำดับจากน้อยไปมาก (Left → Root → Right)
